...
// same as model M2 but with an additional latent random effect in the linear predictor of
// abundance. Expected to correct for extra-Poisson dispersion in the data, but at the cost of
// decreased certainty in the parameter estimates.
...
transformed parameters {
  vector[R] log_mu; // Log population size
